...
export UUID=${UUID:-'0003db34-5744-4220-8603-dc5df75cfef0'} # 如开启哪吒v1,不同的平台需要改一下，否则会覆盖
export NEZHA_SERVER=${NEZHA_SERVER:-'nz.lilyonlyone.eu.org'}       # v1哪吒填写形式：nezha.abc.com:8008,v0哪吒填写形式：nezha.abc.com
export NEZHA_PORT=${NEZHA_PORT:-'443'}           # v1哪吒不要填写这个,v0哪吒agent端口为{443,8443,2053,2083,2087,2096}其中之一时自动开启tls
export NEZHA_KEY=${NEZHA_KEY:-'FTeCQhTeQht5n8FW9j'}             # 哪吒v0-agent密钥或v1的NZ_CLIENT_SECRET
...
export DISABLE_ARGO=${DISABLE_ARGO:-'true'}  # 是否禁用argo, true为禁用,false为不禁用
